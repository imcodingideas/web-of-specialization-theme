  ...
  <div class="container mx-auto">
    <div class="flex flex-col items-center border-t border-slate-400/10 py-10 px-3 sm:flex-row-reverse sm:justify-between">
      ...
      <div class="flex gap-x-6">
        <a class="group" aria-label="webofspecialization on Twitter" href="https://twitter.com">
        ...
        <a class="group" aria-label="webofspecialization on GitHub" href="https://github.com">
          <svg aria-hidden="true" class="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
